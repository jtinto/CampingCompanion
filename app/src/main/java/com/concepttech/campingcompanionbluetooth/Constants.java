...
public class Constants {
    public static final String MTYPE = "messageType",
            MARGS = "numArgs",
            ASIZE = "arraySize",
            VALUES = "values",
            ROWS = "Rows",
            ...
            BODYEND = "/>",
            INTNUMERICREGEX = "[0-9]+",
            DOUBLENUMERICREGEX = "[-+]?[0-9]*\\.?[0-9]+",
            RESENDLOGMESS = "Resend Requested",
            ERR = "Error: ",
            MESS = "Message: ",
            RTRERR = "RTR mismatch",
            MESSAGENULLERR = "Message was null",
            MESSAGEEMPTYERR = "Message was empty",
